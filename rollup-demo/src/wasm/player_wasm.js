...
var createPlayerModule = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function js_on_video_frame(
      ...
      if (Module.onVideoFrame) {
        Module.onVideoFrame(
          ...
          v_stride,
          pts_ms,
          UTF8ToString(codec_name),
        );
      }
    }
    function js_on_audio_frame(
      channels,
      sample_rate,
      sample_count,
      data_ptr,
    ...
    function assignWasmExports(wasmExports) {
      _player_create = Module["_player_create"] = wasmExports["J"];
      _player_destroy = Module["_player_destroy"] = wasmExports["K"];
      _player_feed_segment = Module["_player_feed_segment"] = wasmExports["L"];
      _player_reset = Module["_player_reset"] = wasmExports["M"];
      _free = Module["_free"] = wasmExports["O"];
      _malloc = Module["_malloc"] = wasmExports["P"];
      __emscripten_timeout = wasmExports["Q"];
      memory = wasmMemory = wasmExports["H"];
      __indirect_function_table = wasmExports["__indirect_function_table"];
      _ff_h264_cabac_tables = Module["_ff_h264_cabac_tables"] =
        wasmExports["N"].value;
    }
    var wasmImports = {
...
if (typeof exports === "object" && typeof module === "object") {
  module.exports = createPlayerModule;
  module.exports.default = createPlayerModule;
} else if (typeof define === "function" && define["amd"])
  define([], () => createPlayerModule);
